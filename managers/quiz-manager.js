class QuizManager {
    ...
    get isQuestionComplete() {
        return this.autocompleteElement && this.autocompleteElement.style.display === 'none';
    }
    ...
    triesScoreReset() {
        if (this.triesScoreCurrentElement) this.triesScoreCurrentElement.textContent = 0;
        if (this.triesScoreMaxElement) this.triesScoreMaxElement.textContent = this.triesMax;
    }
    ...
    triesScoreUpdate() {
        ...
        if (this.triesScoreCurrentElement) this.triesScoreCurrentElement.textContent = currentTries;
    }
    ...
    endStateQuestion(character) {
        if (this.answerSuccessElement) this.answerSuccessElement.src = character.wish;
        if (this.nextButtonElement) this.nextButtonElement.style.display = 'inherit';
        if (this.autocompleteElement) this.autocompleteElement.style.display = 'none';
    }
