const SITES_TOP_GAMES_MINESWEEPER_COMPONENT = {
    ...
    onShow() {
        document.querySelector(`#${GAMES.minesweeper.id}`).classList.remove('d-none');
    },

    onHide() {
        document.querySelector(`#${GAMES.minesweeper.id}`).classList.add('d-none');
    },
};

document.addEventListener('DOMContentLoaded', () => {
    SITES_TOP_GAMES_MINESWEEPER_COMPONENT.VUE_COMPONENT.mount(`#${GAMES.minesweeper.id}`);
});
