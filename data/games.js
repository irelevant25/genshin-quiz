const GAMES = {
    tournament: {
        ...
        cardInfo: 'Pit your favorite characters against each other in a tournament-style competition.',
        modalContent: html`
            <div class="mb-4">
                <h6 class="fw-bold">What is the Character Tournament?</h6>
                <p>
                    Pit your favorite characters against each other in a tournament-style competition. Characters are randomly selected and matched up, and you decide who advances to the next round!
                </p>
            </div>
            ...
            <div class="mb-4">
                ...
                <ul>
                    ...
                    <li>
                        <span class="badge bg-primary">Round-Robin (all-play-all)</span> Every character plays against every other character once. All characters are ranked by points at the end (1
                        point per win).
                    </li>
                </ul>
            </div>
    ...
    minesweeper: {
        ...
        cardImage: 'assets/character/wish/Citlali.avif',
        cardInfo: 'A unique twist on the classic Minesweeper game using elemental reactions.',
        modalContent: html`
            <div class="mb-4">
